...
(() => {
  ...
  loadReactUmd().then(init).catch((err) => {
    ...
    // Reveal the inline-styled raw template so a boot failure degrades to
    // readable static content instead of a blank page.
    var fb = document.createElement("style");
    fb.textContent = "x-dc{display:block!important}";
